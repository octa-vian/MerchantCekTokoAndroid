...
import com.amar.sample.activity.PesananSelesai.ActivityOrderComplate;
...
public class AdapterPesananSelesai extends RecyclerView.Adapter<AdapterPesananSelesai.AdapterPdodukViewHolder> {


    private ArrayList<ModelDaftarProduk> dataList;
    private Activity activity;

    public AdapterPesananSelesai(Activity activity, ArrayList<ModelDaftarProduk> dataList) {
    ...
    public void onBindViewHolder(AdapterPdodukViewHolder holder, int position) {
        ...
        holder.cr_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(activity, ActivityOrderComplate.class);
