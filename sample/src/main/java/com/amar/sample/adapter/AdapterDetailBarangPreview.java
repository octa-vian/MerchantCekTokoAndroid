...
public class AdapterDetailBarangPreview extends RecyclerView.Adapter<AdapterDetailBarangPreview.AdapterPdodukViewHolder> {


    private ArrayList<ModelDaftarProduk> dataList;
    private Activity activity;

    public AdapterDetailBarangPreview(Activity activity, ArrayList<ModelDaftarProduk> dataList) {
