package com.amar.sample.activity.DalamPengiriman;
...
public class ActivityDalamPengiriman extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dalam_pengiriman);
