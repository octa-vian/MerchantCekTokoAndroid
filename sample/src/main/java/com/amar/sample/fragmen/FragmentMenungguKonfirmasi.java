...
public class FragmentMenungguKonfirmasi extends Fragment {

    private View view;
    private Activity activity;
    private RecyclerView recyclerView;
    private AdapterPesananKonfrm adapterDaftarPesanan;
    private ArrayList<ModelDaftarProduk> ListDaftarProduk = new ArrayList<>();

    public FragmentMenungguKonfirmasi() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_menunggu_konfirmasi, container, false);

        recyclerView = view.findViewById(R.id.rc_daftar_pesanan);
        adapterDaftarPesanan = new AdapterPesananKonfrm(activity, ListDaftarProduk);
    ...
    private void addData(){
        new APIvolley(activity, new JSONObject(), "GET", Server.URL_KONFIRMASI_PEMBELI, new APIvolley.VolleyCallback() {
            @Override
